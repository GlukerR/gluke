...
title: Портрет из частиц — интерактивное поле на WebGL
description: 'Фотография разбирается на двадцать тысяч точек: портрет собирается из частиц и расступается там, где проходит курсор. WebGL, один draw call, ноль зависимостей.'
client: Веб-графика
