...
Getic — международный дистрибьютор оборудования MikroTik с офисами в Латвии и Германии. Библиотека собиралась не под разовую съёмку, а под каталог, который пополняется годами: каждая новая позиция должна вставать в общий ряд и открываться во вьювере прямо на странице товара.
...
Библиотека из 50+ моделей в согласованных форматах, каталожные изображения и видеоматериалы. Модели подготовлены для интерактивного просмотра в браузере, поэтому один и тот же ассет используется и в веб-каталоге, и в рендерах.
