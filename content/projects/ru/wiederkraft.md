...
Один набор материалов закрывает и веб-каталог, и печать: одна и та же модель идёт в карточку товара, в каталог и на крупный формат без повторного моделирования.
