...
/* Потолок одновременно кэшируемых инстансов: каждый держит свой
   WebGL-контекст, а браузеры ограничивают их число. На странице категории
   webgl живые превью стоят на всех карточках сразу (сейчас 6 виджетов),
   плюс hero и лаборатория кейса (2) — берём с запасом под будущие кейсы.
   Если лимит всё же превышен, вытесненную карточку компонент пересоздаёт
   при возврате во вьюпорт — см. ProjectCardDemo.vue. */
