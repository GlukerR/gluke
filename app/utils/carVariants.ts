...
export interface CarManifest {
  ...
  /* Габарит подробного уровня в координатах файла (`scripts/car-seat-bounds.mjs`).
     Уровни лежат в одних координатах, и по нему посадка всех уровней известна
     до первого GLB: лёгкий уровень встаёт туда же, где встанет подробный. */
  seatBounds?: { min: number[], max: number[] }
}
