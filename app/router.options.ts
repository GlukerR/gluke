...
export default <RouterConfig>{
  async scrollBehavior(to, from, savedPosition) {
    ...
    /* Обычный переход на другую страницу — плавно наверх: резкий прыжок
       заменяется скроллом, который вместе с индикатором загрузки делает
       навигацию между кейсами осознанной. Для prefers-reduced-motion
       глобальный CSS форсирует мгновенный скролл. */
